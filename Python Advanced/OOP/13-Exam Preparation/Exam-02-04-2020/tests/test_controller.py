...
class TestController(unittest.TestCase):
    ...
    def test_add_player(self):
        ...
        self.assertEqual(self.controller.card_repository.count, 0)
        self.assertEqual(res, "Successfully added player of type Beginner with username: test")
    ...
    def test_add_card(self):
        ...
        self.assertEqual(res, "Successfully added card of type MagicCard with name: test")
